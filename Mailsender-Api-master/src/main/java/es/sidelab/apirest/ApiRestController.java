...
public class ApiRestController {
	...
	@RequestMapping(value = "/crearpdf", method = RequestMethod.POST)
	public ResponseEntity<String> sendEmail(@RequestParam("email") String email,@RequestParam("subject") String subject, @RequestParam("body") String body){
		 ...
		 System.out.println(body);
		 	final String username = "gamingvalleyurjc@gmail.com";
	        final String password = "Davidcalvo69";
